        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    name.set("kotlin-script-toolbox:$artifactId")
                    description.set(project.description)
                    url.set("https://github.com/omarmiatello/kotlin-script-toolbox/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/omarmiatello/kotlin-script-toolbox.git")
                        developerConnection.set("scm:git:ssh://github.com/omarmiatello/kotlin-script-toolbox.git")
                        url.set("https://github.com/omarmiatello/kotlin-script-toolbox/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/omarmiatello/kotlin-script-toolbox/issues")
                    }
                }
            }
        }
