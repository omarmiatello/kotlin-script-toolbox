...
implementation("com.github.omarmiatello.kotlin-script-toolbox:zero-setup:0.1.2")
```

Alternative, only basic support:
```kotlin
// Basic utils + kotlinx.coroutines
implementation("com.github.omarmiatello.kotlin-script-toolbox:core:0.1.2")
// core + gson utils
implementation("com.github.omarmiatello.kotlin-script-toolbox:gson:0.1.2")
// core + telegram client
implementation("com.github.omarmiatello.kotlin-script-toolbox:telegram:0.1.2")
// core + twitter client
implementation("com.github.omarmiatello.kotlin-script-toolbox:twitter:0.1.2")
```
