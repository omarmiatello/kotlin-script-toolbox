...
fun main(args: Array<String>) {
    ...
    // 3. Start workflow https://github.com/omarmiatello/kotlin-script-toolbox/actions/workflows/build-modules.yaml
    val config = ScriptGradleModuleConfig(
        gradleConfig = GradleConfig(
            packagePrefix = "com.github.omarmiatello.kotlinscripttoolbox",
